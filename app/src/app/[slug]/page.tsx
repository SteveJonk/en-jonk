...
// SANITY — every CMS page except home rendered through this catch-all route.
// Disabled while the pages are built as static routes; restore the commented
// code below when wiring the CMS.
