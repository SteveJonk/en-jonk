...
// SANITY — form submissions read the form definition and mail settings from
// Sanity. Disabled while the pages are static (the contact form uses mailto);
// restore the commented code below when wiring the CMS.
export function POST() {
  return NextResponse.json(
    { success: false, message: 'Formulieren zijn nog niet gekoppeld.' },
    { status: 503 },
  );
}
